...
package com.bh.paperplane_study.util;
...
public class Api {
    ...
    public static final String GUOKR_ARTICLES = "http://apis.guokr.com/minisite/article.json?retrieve_type=by_minisite&limit=20";

    // 获取果壳文章的具体信息 V1
    // specific information of guokr post V1
    public static final String GUOKR_ARTICLE_LINK_V1 = "http://apis.guokr.com/minisite/article/";
